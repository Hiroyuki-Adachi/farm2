...
class CleanQrLoginSessionsJobTest < ActiveJob::TestCase
  ...
  test "perform deletes deletable sessions" do
    freeze_time Time.current do
      deletable1 = QrLoginSession.create!(
        consumed_at: nil, expires_at: 2.days.ago, status: :pending, ip_address: "9.9.9.9"
      )
      deletable2 = QrLoginSession.create!(
        consumed_at: 31.days.ago, expires_at: 40.days.ago, status: :consumed, ip_address: "9.9.9.9"
      )
      keep = QrLoginSession.create!(
