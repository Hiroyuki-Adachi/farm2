...
class WorksControllerTest < ActionDispatch::IntegrationTest
  setup do
    ...
    login_as(@user)
    @update = {
      worked_at: "2015-05-05", weather: 'sunny', start_at: "08:00:00", end_at: "17:00:00",
  ...
  test "作業登録(実行)" do
    ...
    assert_equal @update[:weather], work.weather
  ...
  test "作業変更(実行)(確定済)" do
    ...
    assert_equal original_work.weather, work.weather
