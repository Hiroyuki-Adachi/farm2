class CreateOwnedRices < ActiveRecord::Migration[5.2]
  def change
    create_table :owned_rices, comment: "保有米" do |t|
      ...
      t.decimal :owned_count, {null: false, scale: 0, precision: 3, default: 0, comment: "保有米数"}
      t.decimal :relative_count, {null: false, scale: 0, precision: 3, default: 0, comment: "縁故米数"}
