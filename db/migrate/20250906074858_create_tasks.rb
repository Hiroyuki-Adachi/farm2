class CreateTasks < ActiveRecord::Migration[8.0]
  def change
    create_table :tasks, comment: 'タスク' do |t|
      t.string :title, null: false, limit: 64, default: '', comment: 'タスク名'
      t.text :description, null: false, default: '', comment: '説明'
      t.integer :task_status_id, null: false, default: 0, comment: '状態'
      ...
      t.references :creator, null: true, foreign_key: { to_table: :workers }, comment: '作成者'
