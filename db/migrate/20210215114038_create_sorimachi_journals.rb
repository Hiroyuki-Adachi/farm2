class CreateSorimachiJournals < ActiveRecord::Migration[6.0]
  def change
    create_table :sorimachi_journals, comment: "ソリマチ仕訳" do |t|
      ...
      t.integer   :code11,  null: false, limit: 4, comment: "コード1-1"
      t.integer   :code12,  null: false, limit: 4, comment: "コード1-2"
      t.integer   :code13,  null: false, limit: 4, comment: "コード1-3"
      t.integer   :code14,  null: false, limit: 4, comment: "コード1-4"
      t.integer   :code15,  null: false, limit: 4, comment: "コード1-5"
      t.integer   :code16,  null: false, limit: 4, comment: "コード1-6"
      t.integer   :code17,  null: false, limit: 4, comment: "コード1-7"
      t.integer   :code18,  null: false, limit: 4, comment: "コード1-8"
