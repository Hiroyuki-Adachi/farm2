class CreateChemicalStocks < ActiveRecord::Migration[6.1]
  def change
    create_table :chemical_stocks, {comment: "農薬在庫"} do |t|
      ...
      t.decimal   :using,     {null: false, precision: 5, scale: 1, default: 0, comment: "使用量"}
    ...
    add_column :chemicals, :stock_quantity, :decimal, {scale: 0, precision: 6, null: false, default: 0, comment: "在庫数"}  end
end
