...
ActiveRecord::Schema.define(version: 2020_08_21_133432) do
  ...
  create_table "banks", primary_key: "code", id: :string, limit: 4, comment: "金融機関マスタ", force: :cascade do |t|
  ...
  create_table "daily_weathers", primary_key: "target_date", id: :date, comment: "気象", force: :cascade do |t|
