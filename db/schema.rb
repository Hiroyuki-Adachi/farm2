...
ActiveRecord::Schema[7.1].define(version: 2024_06_19_084005) do
  ...
  create_table "user_tokens", comment: "利用者トークン", force: :cascade do |t|
    t.integer "user_id", null: false, comment: "利用者ID"
    t.string "token", limit: 36, default: "", null: false, comment: "トークン(UUID)"
