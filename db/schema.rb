...
ActiveRecord::Schema.define(version: 20180701054817) do
  ...
  create_table "bank_branches", primary_key: ["bank_code", "code"], force: :cascade, comment: "支店マスタ" do |t|
  ...
  create_table "banks", primary_key: "code", id: :string, limit: 4, comment: "金融機関コード", force: :cascade, comment: "金融機関マスタ" do |t|
  ...
  create_table "broccoli_boxes", id: :serial, comment: "ブロッコリ箱マスタ", force: :cascade, comment: "ブロッコリ箱マスタ" do |t|
  ...
  create_table "broccoli_harvests", id: :serial, comment: "ブロッコリー収穫", force: :cascade, comment: "ブロッコリー収穫" do |t|
  ...
  create_table "broccoli_ranks", id: :serial, comment: "ブロッコリ等級マスタ", force: :cascade, comment: "ブロッコリ等級マスタ" do |t|
    t.string "display_name", limit: 10, default: "", null: false, comment: "表示名"
    t.integer "display_order", default: 0, null: false, comment: "表示順"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "broccoli_sizes", id: :serial, comment: "ブロッコリ階級マスタ", force: :cascade, comment: "ブロッコリ階級マスタ" do |t|
    t.string "display_name", limit: 10, default: "", null: false, comment: "表示名"
    t.integer "display_order", default: 0, null: false, comment: "表示順"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "chemical_kinds", id: :serial, comment: "作業種別薬剤種別利用マスタ", force: :cascade, comment: "作業種別薬剤種別利用マスタ" do |t|
  ...
  create_table "chemical_terms", id: :serial, force: :cascade, comment: "薬剤年度別利用マスタ" do |t|
  ...
  create_table "chemical_types", id: :serial, comment: "薬剤種別マスタ", force: :cascade, comment: "薬剤種別マスタ" do |t|
  ...
  create_table "chemicals", id: :serial, comment: "薬剤マスタ", force: :cascade, comment: "薬剤マスタ" do |t|
  ...
  create_table "depreciation_types", id: :serial, comment: "減価償却分類", force: :cascade, comment: "減価償却分類" do |t|
  ...
  create_table "depreciations", id: :serial, comment: "減価償却", force: :cascade, comment: "減価償却" do |t|
    t.integer "term", null: false, comment: "年度(期)"
  ...
  create_table "expense_work_types", id: :serial, comment: "経費作業種別", force: :cascade, comment: "経費作業種別" do |t|
  ...
  create_table "expenses", id: :serial, comment: "経費", force: :cascade, comment: "経費" do |t|
    t.integer "term", null: false, comment: "年度(期)"
  ...
  create_table "fixes", primary_key: ["term", "fixed_at"], force: :cascade, comment: "確定データ" do |t|
  ...
  create_table "homes", id: :serial, comment: "世帯マスタ", force: :cascade, comment: "世帯マスタ" do |t|
  ...
  create_table "land_costs", id: :serial, comment: "土地原価", force: :cascade, comment: "土地原価" do |t|
  ...
  create_table "land_places", id: :serial, comment: "場所マスタ", force: :cascade, comment: "場所マスタ" do |t|
  ...
  create_table "lands", id: :serial, comment: "土地マスタ", force: :cascade, comment: "土地マスタ" do |t|
  ...
  create_table "machine_kinds", id: :serial, comment: "作業種別機械利用可能マスタ", force: :cascade, comment: "作業種別機械利用可能マスタ" do |t|
  ...
  create_table "machine_price_details", id: :serial, comment: "機械利用単価マスタ(明細)", force: :cascade, comment: "機械利用単価マスタ(明細)" do |t|
  ...
  create_table "machine_price_headers", id: :serial, comment: "機械利用単価マスタ(ヘッダ)", force: :cascade, comment: "機械利用単価マスタ(ヘッダ)" do |t|
  ...
  create_table "machine_results", id: :serial, comment: "機械稼動データ", force: :cascade, comment: "機械稼動データ" do |t|
    t.integer "machine_id", comment: "機械"
  ...
  create_table "machine_types", id: :serial, comment: "機械種別マスタ", force: :cascade, comment: "機械種別マスタ" do |t|
  ...
  create_table "machines", id: :serial, comment: "機械マスタ", force: :cascade, comment: "機械マスタ" do |t|
  ...
  create_table "organizations", id: :serial, comment: "組織(体系)マスタ", force: :cascade, comment: "組織(体系)マスタ" do |t|
  ...
  create_table "schedule_workers", id: :serial, comment: "作業予定作業者", force: :cascade, comment: "作業予定作業者" do |t|
  ...
  create_table "schedules", id: :serial, comment: "作業予定", force: :cascade, comment: "作業予定" do |t|
    t.integer "term", null: false, comment: "年度(期)"
  ...
  create_table "sections", id: :serial, comment: "班／町内マスタ", force: :cascade, comment: "班／町内マスタ" do |t|
  ...
  create_table "seedling_homes", id: :serial, comment: "育苗担当世帯", force: :cascade, comment: "育苗担当世帯" do |t|
  ...
  create_table "seedling_results", id: :serial, comment: "育苗結果", force: :cascade, comment: "育苗結果" do |t|
  ...
  create_table "seedlings", id: :serial, comment: "育苗", force: :cascade, comment: "育苗" do |t|
    t.integer "term", null: false, comment: "年度(期)"
    t.integer "work_type_id", comment: "作業分類"
  ...
  create_table "systems", id: :serial, comment: "システムマスタ", force: :cascade, comment: "システムマスタ" do |t|
    t.integer "term", null: false, comment: "年度(期)"
  ...
  create_table "users", id: :serial, comment: "利用者マスタ", force: :cascade, comment: "利用者マスタ" do |t|
  ...
  create_table "work_broccolis", id: :serial, comment: "ブロッコリー作業", force: :cascade, comment: "ブロッコリー作業" do |t|
  ...
  create_table "work_chemicals", id: :serial, comment: "薬剤使用データ", force: :cascade, comment: "薬剤使用データ" do |t|
    t.integer "work_id", null: false, comment: "作業"
    t.integer "chemical_id", null: false, comment: "薬剤"
    t.decimal "quantity", precision: 5, scale: 1, default: "0.0", null: false, comment: "使用量"
    t.datetime "created_at"
  ...
  create_table "work_kind_prices", id: :serial, comment: "作業単価マスタ", force: :cascade, comment: "作業単価マスタ" do |t|
    t.integer "term", null: false, comment: "年度(期)"
    t.integer "work_kind_id", null: false, comment: "作業種別"
  ...
  create_table "work_kind_types", id: :serial, comment: "作業種別分類対応マスタ", force: :cascade, comment: "作業種別分類対応マスタ" do |t|
  ...
  create_table "work_kinds", id: :serial, comment: "作業種別マスタ", force: :cascade, comment: "作業種別マスタ" do |t|
  ...
  create_table "work_lands", id: :serial, comment: "作業地データ", force: :cascade, comment: "作業地データ" do |t|
  ...
  create_table "work_results", id: :serial, comment: "作業結果データ", force: :cascade, comment: "作業結果データ" do |t|
    t.integer "work_id", comment: "作業"
    t.integer "worker_id", comment: "作業者"
  ...
  create_table "work_types", id: :serial, comment: "作業分類マスタ", force: :cascade, comment: "作業分類マスタ" do |t|
  ...
  create_table "work_verifications", id: :serial, comment: "日報検証", force: :cascade, comment: "日報検証" do |t|
    t.integer "work_id", comment: "作業"
    t.integer "worker_id", comment: "作業者"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "workers", id: :serial, comment: "作業者マスタ", force: :cascade, comment: "作業者マスタ" do |t|
  ...
  create_table "works", id: :serial, comment: "作業データ", force: :cascade, comment: "作業データ" do |t|
    t.integer "term", null: false, comment: "年度(期)"
